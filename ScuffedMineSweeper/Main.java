    ...
    public static void run(){
        ...
        play.addActionListener( new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if(diff == 3){
                    if(!(customDim.getText().isEmpty()) && (Integer.parseInt(customDim.getText()) >= 9 && Integer.parseInt(customDim.getText()) <= 100)){ //catch exception for cool
                        //do nothing
                    }else{
        ...
        customDim.addMouseListener(new java.awt.event.MouseAdapter() {
