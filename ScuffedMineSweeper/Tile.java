...
//        System.out.println("Revealed: " + this.gridx + ", " + this.gridy);
        if(this.isMine){
            ...
            if(this.adjacentMines == 0){
                ...
                for(int i = -1; i <= 1; i++){
                    for(int j = -1; j <= 1; j++){
                        if(!(i == 0 && j == 0) && (this.gridx+i >= 0 && this.gridx+i < Main.board.width) && (this.gridy+j >= 0 && this.gridy+j < Main.board.height)){
                        ...
                        //    "\n but 0<"+(this.gridx+i)+"<"+(Main.board.width-1)+" or 0<"+(this.gridy+j)+"<"+(Main.board.height-1));
                    }
                }
            }else{
